import {
  d
} from "./chunk-TUXS45UG.js";
import {
  c
} from "./chunk-2QLL2RAS.js";
import {
  n as n2
} from "./chunk-YWBF5UW6.js";
import {
  v
} from "./chunk-JZIXUDKS.js";
import {
  x as x3
} from "./chunk-VFF4M2R5.js";
import {
  h
} from "./chunk-SXTMKWFY.js";
import {
  h as h2
} from "./chunk-6AOVL2GZ.js";
import {
  require_react_material_ui_form_builder
} from "./chunk-RVIPY56T.js";
import {
  u
} from "./chunk-C3IB67EL.js";
import {
  j
} from "./chunk-2KPIZOKW.js";
import {
  E
} from "./chunk-MZ3EYSFG.js";
import {
  x as x4
} from "./chunk-HFQ3VSLP.js";
import {
  p
} from "./chunk-KI5OUF5X.js";
import "./chunk-IOOTSF4V.js";
import {
  g
} from "./chunk-ORRPIAFK.js";
import {
  x
} from "./chunk-GB6X3XGI.js";
import {
  x as x2
} from "./chunk-XVOWURW4.js";
import "./chunk-BQNFHU65.js";
import "./chunk-NCP6KRCP.js";
import {
  require_Stack,
  require_baseIsEqual,
  require_isArguments,
...
// node_modules/@jeremyling/react-material-ui-form-builder/dist/es/FormBuilder.js
...
var a = function() {
  return a = Object.assign || function(t2) {
    for (var r2, e3 = 1, o = arguments.length; e3 < o; e3++)
      for (var n4 in r2 = arguments[e3])
        Object.prototype.hasOwnProperty.call(r2, n4) && (t2[n4] = r2[n4]);
    return t2;
  }, a.apply(this, arguments);
};
var d2 = loadable_esm_default(function() {
  return import("./StandardAutocomplete-W5XX4KSE.js");
});
var c2 = loadable_esm_default(function() {
  return import("./StandardCheckboxGroup-OEG5JCOR.js");
});
var u2 = loadable_esm_default(function() {
  return import("./StandardChipGroup-KPHWZ7AK.js");
});
var p2 = loadable_esm_default(function() {
  return import("./StandardCounter-644d2480-JMQFSWD3.js");
});
var m = loadable_esm_default(function() {
  return import("./StandardDatePicker-HEWBMUTJ.js");
});
var l = loadable_esm_default(function() {
  return import("./StandardDateTimePicker-2LG5Z4II.js");
});
var f = loadable_esm_default(function() {
  return import("./StandardEditor-BOIMHW2R.js");
});
var x5 = loadable_esm_default(function() {
  return import("./StandardFileUpload-GHL7IGAI.js");
});
var j2 = loadable_esm_default(function() {
  return import("./StandardImagePicker-J5XX3YVK.js");
});
var h3 = loadable_esm_default(function() {
  return import("./StandardRadioGroup-PCGGPUKB.js");
});
var g2 = loadable_esm_default(function() {
  return import("./StandardRating-TPPU5WEY.js");
});
var S = loadable_esm_default(function() {
  return import("./StandardSelect-YP3BBMY7.js");
});
var k = loadable_esm_default(function() {
  return import("./StandardSwitch-TNFFANNP.js");
});
var b = loadable_esm_default(function() {
  return import("./StandardTextField-WZCTVCBX.js");
});
var v2 = loadable_esm_default(function() {
  return import("./StandardTimePicker-35TRQXYW.js");
});
function y(r2, o) {
  switch (r2.component) {
    case "date-picker":
      return e.exports.jsx(m, { field: r2, methods: o });
    case "date-time-picker":
      return e.exports.jsx(l, { field: r2, methods: o });
    case "time-picker":
      return e.exports.jsx(v2, { field: r2, methods: o });
    case "select":
      return e.exports.jsx(S, { field: r2, methods: o });
    case "autocomplete":
      return e.exports.jsx(d2, { field: r2, methods: o });
    case "chip-group":
      return e.exports.jsx(u2, { field: r2, methods: o });
    case "checkbox-group":
      return e.exports.jsx(c2, { field: r2, methods: o });
    case "radio-group":
      return e.exports.jsx(h3, { field: r2, methods: o });
    case "switch":
      return e.exports.jsx(k, { field: r2, methods: o });
    case "file-upload":
      return e.exports.jsx(x5, { field: r2, methods: o });
    case "image-picker":
      return e.exports.jsx(j2, { field: r2, methods: o });
    case "rating":
      return e.exports.jsx(g2, { field: r2, methods: o });
    case "counter":
      return e.exports.jsx(p2, { field: r2, methods: o });
    case "display-text":
      return e.exports.jsx(n, { field: r2 });
    case "display-image":
      var i = r2;
      return e.exports.jsx(Box_default, a({ sx: { display: "flex", justifyContent: "center" } }, { children: e.exports.jsx("img", a({ src: i.src, alt: i.alt, title: i.alt }, i.props, { loading: "lazy" })) }));
    case "rich-text":
      return e.exports.jsx(f, { field: r2, methods: o });
    case "custom":
      return e.exports.jsx(Controller, { name: r2.attribute || "", control: o.control, render: function(t2) {
        var e3 = t2.field;
        return r2.customComponent(r2, o, e3);
      } });
    default:
      return e.exports.jsx(b, { field: r2, methods: o });
  }
}
function P(e3) {
  var o = e3.fields, s = e3.defaultValue, d3 = e3.children, c3 = e3.errors, u3 = e3.methods, p3 = e3.sx;
  return (0, import_react2.useEffect)(function() {
    u3.reset(s);
  }, [s]), (0, import_react2.useEffect)(function() {
    if (c3)
      for (var t2 = 0, r2 = c3; t2 < r2.length; t2++) {
        var e4 = r2[t2];
        u3.setError(e4.attribute, { type: e4.type, message: e4.message });
      }
  }, [c3]), e.exports.jsxs(Box_default, { children: [e.exports.jsx(Grid_default, a({ container: true, spacing: 1, sx: p3 }, { children: null == o ? void 0 : o.map(function(r2, e4) {
    return r2 = function(t2, r3) {
      return t2.id || (t2.id = t2.attribute, r3 && (t2.id = r3 + "-" + t2.id), t2.idPrefix && (t2.id = t2.idPrefix + "-" + t2.id)), t2;
    }(r2, e4), !r2.hideCondition && e.exports.jsx(Grid_default, a({ item: true }, { xs: (o2 = (o2 = r2.col) || {}).xs || 12, sm: o2.sm, md: o2.md, lg: o2.lg, xl: o2.xl }, r2.containerProps, { children: y(r2, u3) }), r2.id || r2.attribute || e4);
    var o2;
  }) })), d3] });
}
...
var ReferenceSet = class _ReferenceSet {
  ...
  resolveAll(resolve) {
    return this.toArray().reduce((acc, e3) => acc.concat(Reference.isRef(e3) ? resolve(e3) : e3), []);
  }
  add(value) {
...
` + (formattedResult !== formattedValue ? `result of cast: ${formattedResult}` : ""));
  ...
  describe() {
    ...
    const description = {
      ...
      })).filter((n4, idx, list) => list.findIndex((c3) => c3.name === n4.name) === idx)
    };
    return description;
  }
};
...
function sortFields(fields, excludedEdges = []) {
  ...
  let excludes = new Set(excludedEdges.map(([a3, b2]) => `${a3}-${b2}`));
...
function sortByKeyOrder(keys) {
  return (a3, b2) => {
    return findIndex(keys, a3) - findIndex(keys, b2);
  };
}
...
var ObjectSchema = class extends BaseSchema {
  ...
  _cast(_value, options = {}) {
    ...
    let props = this._nodes.concat(Object.keys(value).filter((v3) => this._nodes.indexOf(v3) === -1));
...
var ArraySchema = class extends BaseSchema {
  ...
  _cast(_value, _opts) {
    ...
    const castArray = value.map((v3, idx) => {
      const castElement = this.innerType.cast(v3, _extends6({}, _opts, {
        path: `${_opts.path || ""}[${idx}]`
      }));
      if (castElement !== v3) {
        isChanged = true;
...
// node_modules/@jeremyling/react-material-ui-form-builder/dist/es/validation-11519a6c.js
function e2(r2) {
  return t(r2);
}
function a2(e3, a3, t2) {
  var n4;
  switch (e3) {
    case "string":
      n4 = create4();
  ...
  n4 = n4.optional().label(t2 || "This");
  for (var i = 0, o = a3 || []; i < o.length; i++) {
    var c3 = o[i], u3 = c3[0], s = c3[1];
    n4 = true === s ? n4[u3]() : Array.isArray(s) && !["oneOf", "notOneOf"].includes(u3) ? n4[u3].apply(n4, s) : n4[u3](s);
  }
  return n4;
}
var t = function(e3) {
  return e3.reduce(function(e4, t2) {
    var n4, i, o = t2.attribute, c3 = t2.validationType, u3 = t2.validations, s = t2.label;
    if (!o)
      return e4;
    if (!es_exports[c3 || "mixed"])
      return e4;
    var b2 = a2(c3, u3, s);
    if (!(o.indexOf(".") >= 0))
      return e4.concat(create7(((n4 = {})[o] = b2, n4)));
    var l2 = o.split(".").reverse(), f2 = l2.slice(1).reduce(function(e5, a3) {
      var t3, n5;
      return isNaN(Number(a3)) ? e5.array ? ((t3 = {})[a3] = e5.array, t3) : ((n5 = {})[a3] = create7(e5), n5) : { array: create8(create7(e5)) };
    }, ((i = {})[l2[0]] = b2, i)), d3 = create7(f2);
    return e4.concat(d3);
  }, create7({}).required());
};
var n3 = Object.freeze({ __proto__: null, getFormSchema: e2, getFieldSchema: a2 });

// node_modules/@jeremyling/react-material-ui-form-builder/dist/es/index.js
var import_react3 = __toESM(require_react());
var import_get = __toESM(require_get());
var import_isEqual = __toESM(require_isEqual());
var import_isObject = __toESM(require_isObject());
var import_AdapterDateFns = __toESM(require_react_material_ui_form_builder());
export {
  P as FormBuilder,
  g as StandardAutocomplete,
  x as StandardCheckboxGroup,
  x2 as StandardChipGroup,
  x3 as StandardCounter,
  h as StandardDatePicker,
  h2 as StandardDateTimePicker,
  u as StandardEditor,
  j as StandardFileUpload,
  E as StandardImagePicker,
  x4 as StandardRadioGroup,
  p as StandardRating,
  d as StandardSelect,
  c as StandardSwitch,
  n2 as StandardTextField,
  v as StandardTimePicker,
  n3 as validationUtils
};
//# sourceMappingURL=@jeremyling_react-material-ui-form-builder.js.map
